...
export default function DashboardPOS() {
  ...
  const currentUserObj = usersList.find(u => u.username === currentUsername);
  const currentRoleObj = rolesList.find(r => r.name === currentUserObj?.role);
  const userPermissions: Permission[] = currentRoleObj ? currentRoleObj.permissions : ['view_pos'];
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col font-sans">
      ...
      <main className="flex-1 p-6 max-w-7xl w-full mx-auto">
        {/* PESTAÑA: POS */}
        {activeTab === 'pos' && canView('view_pos') && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 flex flex-col space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {filteredProductList(filteredProducts).map(prod => (
                  <div 
                    key={prod.id} 
        ...
        {/* PESTAÑA: INVENTARIO */}
        {activeTab === 'inventory' && canView('view_inventory') && (
        ...
        {/* PESTAÑA: REPORTES */}
        {activeTab === 'reports' && canView('view_reports') && (
        ...
        {activeTab === 'accounts' && canView('view_accounts') && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {/* PESTAÑA: CLIENTES */}
        {activeTab === 'customers' && canView('view_customers') && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {activeTab === 'roles' && canView('view_roles') && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <RolesManagerModule />
          </div>
        )}
...
function filteredProductList(products: Product[]) {
  return products;
}
