      ...
      <header className="bg-slate-900 border-b border-slate-800 px-6 py-4 flex flex-col xl:flex-row justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 bg-slate-950 border border-slate-800 px-3 py-1.5 rounded-xl text-xs">
            ...
            <div>
              <div className="font-semibold text-white leading-tight">{currentUserObj.name}</div>
              <div className="text-[10px] text-blue-400 uppercase font-bold">ROL : {currentRoleObj.name}</div>
            </div>
            <div className="ml-2 pl-2 border-l border-slate-800 flex items-center gap-1.5">
              ...
              <select 
                ...
                className="bg-slate-900 text-xs text-white border border-slate-700 rounded px-2 py-1 font-medium focus:outline-none focus:border-blue-500"
              >
                {usersList.map(u => (
